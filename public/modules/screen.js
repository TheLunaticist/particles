import { UIText, HorizontalAnchor, VerticalAnchor, UIButton, } from "modules/uiElement.js";
...
export class StartScreen extends Screen {
    constructor() {
        super(false);
        this.uiElements.push(UIText.new({
        ...
        this.uiElements.push(UIButton.new({
            anchorVertical: VerticalAnchor.MIDDLE,
            anchorHorizontal: HorizontalAnchor.MIDDLE,
