...
import { Building, BuildingType, Enemy, EnemyType, EntityList, } from "modules/entity.js";
...
export class Level {
    constructor(levelDescriptor) {
        ...
        this.cm = new CollisionMap(levelDescriptor.size.x, levelDescriptor.size.y);
        this.buildings.push(Building.newFromCenter(new Vec2(0, 0), BuildingType.HQ));
